...
CREATE TABLE `withdrawTemplate` (
    ...
    `amountMultiplier` VARCHAR(191) NULL,
...
CREATE TABLE `OrderTemplate` (
    ...
    `side` VARCHAR(191) NOT NULL,
    `limitPrice` VARCHAR(191) NULL,
    `limitPriceMultiplier` VARCHAR(191) NULL,
    `stopPrice` VARCHAR(191) NULL,
    `stopPriceMultiplier` VARCHAR(191) NULL,
    `quantity` VARCHAR(191) NOT NULL,
    `quantityMultiplier` VARCHAR(191) NULL,
    `icebergQty` VARCHAR(191) NULL,
    `icebergQtyMultiplier` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
